        ...
        return {
            ...
            CallExpression(node) {
                ...
                if (
                    ...
                    context.report({
                        node: node,
                        message: 'Avoid using setTimeout in test code. For more information, visit https://github.com/luissmonteiro/eslint-plugin-test-smells/blob/main/docs/rules/sleepy-test.md',
                    });
                }
            }
        };
