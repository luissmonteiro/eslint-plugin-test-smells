                ...
                if (node.callee.name === 'test' || node.callee.name === 'it') {
                    ...
                    if (testFunction && (testFunction.type === 'ArrowFunctionExpression' || testFunction.type === 'FunctionExpression')) {
                        ...
                        if (!hasAssertion) {
                            context.report({
                                node: node,
                                message: 'Test methods should include at least one assertion. For more information, visit: https://github.com/luissmonteiro/eslint-plugin-test-smells/blob/main/docs/rules/unknown-test.md',
                            });
                        }
                    }
                }
