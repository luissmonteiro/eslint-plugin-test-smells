            ...
            return {
                CallExpression: function(node) {
                    if(checkIfStatements(node) >= 1){
                        context.report({
                            node: node,
                            message: "Avoid using conditional test logic. For more information, visit https://github.com/luissmonteiro/eslint-plugin-test-smells/blob/main/docs/rules/conditional-test-logic.md"
                        });
                    }
                }
            }
