        ...
        return {
            TryStatement: function (node) {
                if (checkExceptions(node) >=1) {
                    context.report({
                        node: node,
                        message: 'Try to avoid exception handling. For more information, visit https://github.com/luissmonteiro/eslint-plugin-test-smells/blob/main/docs/rules/exception-handling.md',
                    });
                }
            },
        };
